...
export class TerseAppFacade implements OnDestroy {
  title = 'terse';
  ...
  /** @deprecated Use Router links; kept for templates during migration */
  setSearchMode(mode: 'basic' | 'advanced' | 'puzzle' | 'games' | 'admin' | 'performance' | 'profile') {
    ...
    void this.router.navigateByUrl(routeMap[mode] || '/word-check');
  }
